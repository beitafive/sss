      ...
      navList: [
        {
          ...
          details:
            "这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字adssadsadsadsadsa阿萨德萨达四大adsd"
        },
        {
          id: "2",
          name: "下城司法所",
          ...
          details:
            "这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字这里是规章制度内容文字"
        }
      ]
    };
  },
